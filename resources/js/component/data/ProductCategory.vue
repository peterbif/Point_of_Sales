            ...
            <form @submit.prevent="saveData" id="form">
              <div class="row">
                <div class="col-12 mb-3">
                  ...
                  <input type="text" :class="['form-control', { 'is-invalid': errors.name }]" v-model="form.category_name"
                    ref="autofocus" />
                ...
                <div class="col-md-10">
                  <div class="row justify-content-start">
                    <div class="col-lg-3 col-sm-6">
                      ...
                      <input type="text" class="form-control" v-model="filter.category_name" placeholder="Search..." />
                    </div>
                  </div>
                </div>
